System.register("chunks:///_virtual/Constant.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      Constant.SIGN_MESSAGE_ENDPOINT = "unity/sign-message?" + _class.FLAG_COCOS + "&message=";
      Constant.SIGN_TRANSACTION_ENDPOINT = "unity/sign-transaction?" + _class.FLAG_COCOS;
      Constant.SIGN_OUT = "signout";
      //https://auth.v2.ramper.xyz/wallet/signin?chainName=tomo&isCocosForce=true
      // public static readonly END_POINT: string = "https://ramper-v2-auth-stg.coin98.dev/"
      Constant.END_POINT = "https://ramper-v2-auth-test.coin98.dev/";
      // public static readonly END_POINT: string = "https://auth.v2.ramper.xyz/"
      // public static readonly END_POINT: string = "http://10.40.0.248:3000/";
      Constant.SIGN_MESSAGE = _class.END_POINT + _class.SIGN_MESSAGE_ENDPOINT;
    ...
    execute: function () {
      ...
      var Main = exports('Main', (_dec = ccclass('Main'), _dec2 = property(WebView), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.onClickSignin = function onClickSignin(url) {
          console.log("---------------------onClickSignin START");
          // this.wb.url = '';
