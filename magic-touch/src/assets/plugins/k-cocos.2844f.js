(function (root) {
  ...
  (function () {
    ...
    (function (global) {
      ...
      // }
      //var _originCalculateDeltaTime = cc.game._deltaTime;

      cc.game._kSpeed = 1;

      cc.kSpeed = function (speed) {
        cc.game._kSpeed = speed;
      }; // var DEBUG_DT_THRESHOLD = 1;
      // cc.game._calculateDT = () => {
      //   const now = performance.now();
      //   cc.game._deltaTime =
      //     now > cc.game._startTime ? (now - cc.game._startTime) / 1000 : 0;
      //   if (cc.game._deltaTime > DEBUG_DT_THRESHOLD) {
      //     cc.game._deltaTime = cc.game.frameTime / 1000;
      //   }
      //   cc.game._startTime = now * cc.game._kSpeed;
      //   return cc.game._deltaTime;
      // };
